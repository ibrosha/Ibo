  ...
  return (
    <div>
      ...
      >
        ...
        <h1 className="text-[40px] font-[650]">Популярные магазины</h1>
      </div>

      <div className='flex flex-wrap gap-[25px_0] justify-between items-center px-[5%] py-[50px]'>
        <img src={img1} alt="" className='w-[19%] md:w-[49%] rounded-[20px] shadow-xl'/>
        <img src={img1} alt="" className='w-[19%] md:w-[49%] rounded-[20px] shadow-xl'/>
        <img src={img1} alt="" className='w-[19%] md:w-[49%] rounded-[20px] shadow-xl'/>
        <img src={img1} alt="" className='w-[19%] md:w-[49%] rounded-[20px] shadow-xl'/>
        <img src={img1} alt="" className='w-[19%] md:w-[49%] rounded-[20px] shadow-xl'/>
